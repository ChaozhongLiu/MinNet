...
# To load the dataset
class test_data_cite(object):
    def __init__(self, mod1, mod2, batch_number=200):
        super(test_data_cite, self).__init__()
...
class Siamese_Test_cite(object):

    def __init__(self, dataset, num_prts, num_genes):
        super(Siamese_Test_cite, self).__init__()
        self.dataset = dataset
        self.D = SiamAtt_cite(num_prts, num_genes).cuda()
