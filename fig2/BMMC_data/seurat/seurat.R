#setwd('/mnt/hdd/chaozhong/manuscript/fig2/BMMC_data/seurat/')
library(Seurat)
library(ggplot2)
library(patchwork)
library(hdf5r)
...
# rds is got from humble:~/thesis/BMMC_val/
# ATAC processing ----
...
activity.matrix <- CreateGeneActivityMatrix(peak.matrix = peaks,
                                            annotation.file = "Homo_sapiens.GRCh38.104.gtf", 
...
dim(umap_coembed)
all(gsub('_1','_2',rownames(umap_coembed)[1:12163]) == rownames(umap_coembed)[12164:24326])
...
dim(pca_coembed)
all(gsub('_1','_2',rownames(pca_coembed)[1:12163]) == rownames(pca_coembed)[12164:24326])
