...
out_x = pd.read_csv('../results/raw/LigerOnline_UMAPembed.rna.%s.txt'%(randn),header=None)
out_y = pd.read_csv('../results/raw/LigerOnline_UMAPembed.atac.%s.txt'%(randn),header=None)
...
writer = open('../results/raw/neighborhood_s1d2_LigerOnline.UMAP.%s.txt'%(randn),'w')
...
writer = open('../results/raw/neighborhood_s3d7_LigerOnline.UMAP.%s.txt'%(randn),'w')
writer.write('\n'.join(np.diag(neighbor_2).astype('str').tolist()))
writer.close()

#-----------------------------------------------------------------------------------------
meta = pd.read_csv('../bmmc.rna.meta.csv')
out_x = pd.read_csv('../results/raw/LigerOnline_embed.rna.%s.txt'%(randn),header=None)
out_y = pd.read_csv('../results/raw/LigerOnline_embed.atac.%s.txt'%(randn),header=None)
...
writer = open('../results/raw/neighborhood_s1d2_LigerOnline.%s.txt'%(randn),'w')
writer.write('\n'.join(np.diag(neighbor_1).astype('str').tolist()))
writer.close()
...
writer = open('../results/raw/neighborhood_s3d7_LigerOnline.%s.txt'%(randn),'w')
writer.write('\n'.join(np.diag(neighbor_2).astype('str').tolist()))
writer.close()

#-----------------------------------------------------------------------------------------
meta = pd.read_csv('../bmmc.rna.meta.csv')
out_x = pd.read_csv('../results/raw/LigerOnline_embed.rna.%s.txt'%(randn),header=None).iloc[:,1:].to_numpy()
out_y = pd.read_csv('../results/raw/LigerOnline_embed.atac.%s.txt'%(randn),header=None).iloc[:,1:].to_numpy()
...
#-----------------------------------------------------------------------------------------
meta = pd.read_csv('../bmmc.rna.meta.csv')
out_x = pd.read_csv('../results/raw/LigerOnline_UMAPembed.rna.%s.txt'%(randn),header=None).iloc[:,1:].to_numpy()
out_y = pd.read_csv('../results/raw/LigerOnline_UMAPembed.atac.%s.txt'%(randn),header=None).iloc[:,1:].to_numpy()
