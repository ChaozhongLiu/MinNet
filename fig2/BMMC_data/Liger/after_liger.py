...
out_x = pd.read_csv('Liger_UMAPembed.rna.%s.txt'%(randn),header=None)
out_y = pd.read_csv('Liger_UMAPembed.atac.%s.txt'%(randn),header=None)
...
writer = open('../results/raw/neighborhood_s1d2_Liger.UMAP.%s.txt'%(randn),'w')
...
writer = open('../results/raw/neighborhood_s3d7_Liger.UMAP.%s.txt'%(randn),'w')
...
writer = open('../results/raw/neighborhood_s1d2_Liger.%s.txt'%(randn),'w')
writer.write('\n'.join(np.diag(neighbor_1).astype('str').tolist()))
writer.close()
...
writer = open('../results/raw/neighborhood_s3d7_Liger.%s.txt'%(randn),'w')
writer.write('\n'.join(np.diag(neighbor_2).astype('str').tolist()))
writer.close()
