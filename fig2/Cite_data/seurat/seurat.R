setwd('/mnt/hdd/chaozhong/manuscript/fig2/Cite_data/seurat/')
library(Seurat)
library(ggplot2)
library(patchwork)
library(hdf5r)
...
dim(pca_coembed)
all(gsub('_1','_2',rownames(pca_coembed)[1:14826]) == rownames(pca_coembed)[14827:29652])
...
dim(umap_coembed)
all(gsub('_1','_2',rownames(umap_coembed)[1:14826]) == rownames(umap_coembed)[14827:29652])
