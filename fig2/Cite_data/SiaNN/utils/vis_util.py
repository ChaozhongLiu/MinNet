...
def umap_plot(representations, labels, ct_dic, batch, batch_dic, min_dist=0.5, n_neigh=10):
    ...
    legend_elements = [Line2D([0], [0], marker='o', color='w', label='GEX',
                        ...
                        Line2D([0], [0], marker='o', color='w', label='ADT',
    ...
    plt.clf()
    fig, ax = plt.subplots(figsize=(5,5))
    scatter = ax.scatter(u[:, 0], u[:, 1], s=3, alpha=0.5, c=CAND_COLORS[domains])
    ax.set_xlabel("UMAP1")
    ax.set_ylabel("UMAP2")
    #legend1 = ax.legend(*scatter.legend_elements(),
    #                loc="upper left", title="Classes")
    ...
    plt.clf()
    fig, ax = plt.subplots(figsize=(5,5))
    ax.scatter(u[:, 0], u[:, 1], s=3, alpha=0.5, c=CAND_COLORS[labels])
    ax.set_xlabel("UMAP1")
    ax.set_ylabel("UMAP2")
    ax.legend(handles=legend_elements, loc='upper left', bbox_to_anchor=(1, 1))
