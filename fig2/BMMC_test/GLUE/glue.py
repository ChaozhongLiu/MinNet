...
neighbor_1 = np.argsort(match_matrix_1, axis=1, kind='stable')
neighbor_1 = np.argsort(neighbor_1, axis=1, kind='stable')
writer = open('../results/raw/neighborhood_s4d1_glue.%s.txt'%(randn),'w')
...
writer = open('../results/raw/neighborhood_s4d8_glue.%s.txt'%(randn),'w')
...
writer = open('../results/raw/neighborhood_s4d9_glue.%s.txt'%(randn),'w')
