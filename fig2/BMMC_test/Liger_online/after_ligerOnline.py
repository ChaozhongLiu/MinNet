...
out_x = pd.read_csv('LigerOnline_UMAPembed.rna.%s.txt'%(randn),header=None)
out_y = pd.read_csv('LigerOnline_UMAPembed.atac.%s.txt'%(randn),header=None)
...
neighbor_1 = np.argsort(match_matrix_1, axis=1, kind='stable')
neighbor_1 = np.argsort(neighbor_1, axis=1, kind='stable')
writer = open('../results/raw/neighborhood_s4d1_LigerOnline.UMAP.%s.txt'%(randn),'w')
...
writer = open('../results/raw/neighborhood_s4d8_LigerOnline.UMAP.%s.txt'%(randn),'w')
...
writer = open('../results/raw/neighborhood_s4d9_LigerOnline.UMAP.%s.txt'%(randn),'w')
writer.write('\n'.join(np.diag(neighbor_3).astype('str').tolist()))
writer.close()

#-----------------------------------------------------------------------------------------
meta = pd.read_csv('../bmmc.rna.meta.csv')
out_x = pd.read_csv('LigerOnline_embed.rna.%s.txt'%(randn),header=None)
out_y = pd.read_csv('LigerOnline_embed.atac.%s.txt'%(randn),header=None)
...
neighbor_1 = np.argsort(match_matrix_1, axis=1, kind='stable')
neighbor_1 = np.argsort(neighbor_1, axis=1, kind='stable')
writer = open('../results/raw/neighborhood_s4d1_LigerOnline.%s.txt'%(randn),'w')
writer.write('\n'.join(np.diag(neighbor_1).astype('str').tolist()))
writer.close()
...
neighbor_2 = np.argsort(match_matrix_2, axis=1, kind='stable')
neighbor_2 = np.argsort(neighbor_2, axis=1, kind='stable')
writer = open('../results/raw/neighborhood_s4d8_LigerOnline.%s.txt'%(randn),'w')
writer.write('\n'.join(np.diag(neighbor_2).astype('str').tolist()))
writer.close()
...
neighbor_3 = np.argsort(match_matrix_3, axis=1, kind='stable')
neighbor_3 = np.argsort(neighbor_3, axis=1, kind='stable')
writer = open('../results/raw/neighborhood_s4d9_LigerOnline.%s.txt'%(randn),'w')
writer.write('\n'.join(np.diag(neighbor_3).astype('str').tolist()))
writer.close()

#-----------------------------------------------------------------------------------------
meta = pd.read_csv('../bmmc.rna.meta.csv')
out_x = pd.read_csv('LigerOnline_embed.rna.%s.txt'%(randn),header=None).iloc[:,1:].to_numpy()
out_y = pd.read_csv('LigerOnline_embed.atac.%s.txt'%(randn),header=None).iloc[:,1:].to_numpy()
input_mod1 = ad.read_h5ad('../data/Multiome_GEX.test.h5ad')
...
pred_df.to_csv('../results/raw/LigerOnline_prediction.%s.txt'%(randn))

ct_df = pd.DataFrame({'cell_type':labels_x,
                     'prediction':pred_y})

ct_heatmap = pd.DataFrame(np.zeros((20,20)))
...
acc_df.to_csv('../results/raw/LigerOnline_transfer_acc.%s.csv'%(randn))



#-----------------------------------------------------------------------------------------
meta = pd.read_csv('../bmmc.rna.meta.csv')
out_x = pd.read_csv('LigerOnline_UMAPembed.rna.%s.txt'%(randn),header=None).iloc[:,1:].to_numpy()
out_y = pd.read_csv('LigerOnline_UMAPembed.atac.%s.txt'%(randn),header=None).iloc[:,1:].to_numpy()
input_mod1 = ad.read_h5ad('../data/Multiome_GEX.test.h5ad')
...
pred_df = pd.DataFrame({'cell_type':labels_x,'prediction':pred_y})
pred_df.to_csv('../results/raw/LigerOnline_prediction.UMAP.%s.txt'%(randn))
...
acc_df = pd.DataFrame({'cell_type':ct_heatmap.columns.tolist(),
                       'Liger': np.diag(ct_heatmap)})
acc_df.to_csv('../results/raw/LigerOnline_transfer_acc.UMAP.%s.csv'%(randn))
...
merge.to_csv('../results/raw/LigerOnline_embed.%s.txt'%(randn), index=False)
...
merge.insert(0, 'index', np.concatenate((meta.index.to_numpy(), 
                                         meta.index.to_numpy()), axis=0))
merge.to_csv('../results/raw/LigerOnline_UMAPembed.%s.txt'%(randn), index=False)
