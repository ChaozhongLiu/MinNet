setwd('/mnt/hdd/chaozhong/manuscript/fig2/BMMC_test/Liger_online/')
...
write.table(
  rna_latent, paste0('LigerOnline_embed.rna.',rand_seed,'.txt'), #args$output_rna,
  sep = ",", row.names = TRUE, col.names = FALSE, quote = FALSE, na = ""
)
write.table(
  atac_latent, paste0('LigerOnline_embed.atac.',rand_seed,'.txt'), #args$output_atac,
  sep = ",", row.names = TRUE, col.names = FALSE, quote = FALSE, na = ""
)
...
rownames(atac_latent) <- gsub("\\.ATAC$", "", rownames(atac_latent))
write.table(
  rna_latent, paste0('LigerOnline_UMAPembed.rna.',rand_seed,'.txt'), #args$output_rna,
  sep = ",", row.names = TRUE, col.names = FALSE, quote = FALSE, na = ""
)
write.table(
  atac_latent, paste0('LigerOnline_UMAPembed.atac.',rand_seed,'.txt'), #args$output_atac,
  sep = ",", row.names = TRUE, col.names = FALSE, quote = FALSE, na = ""
)
