setwd('/mnt/hdd/chaozhong/manuscript/fig3/seurat/')
library(Seurat)
library(ggplot2)
library(patchwork)
library(hdf5r)
...
# ATAC processing ----
count_mtx <- readRDS('../data/multiome.s3d7.atac.counts.rds')
bmmc.atac <- CreateSeuratObject(counts = count_mtx, 
                                project = "BMMC",
                                assay = 'peaks')
metadata.atac <- readRDS('../data/multiome.s3d7.meta.rds')
...
saveRDS(bmmc.atac,'bmmc.atac.s3d7.rds')



# RNA-seq processing ----
count_mtx <- readRDS('../data/multiome.s4d1.rna.counts.rds')
bmmc.rna <- CreateSeuratObject(counts = count_mtx, 
                               project = "BMMC",
                               assay = 'RNA')
metadata.rna <- readRDS('../data/multiome.s4d1.meta.rds')
...
saveRDS(bmmc.rna,'bmmc.rna.s4d1.rds')



# integration and label transfer ----
bmmc.rna <- readRDS('bmmc.rna.s4d1.rds')
bmmc.atac <- readRDS('bmmc.atac.s3d7.rds')
...
write.table(metad, '../bmmc.meta.s4s3.csv',quot=F,sep=',')
